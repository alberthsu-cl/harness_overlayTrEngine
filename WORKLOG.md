...
Promote the next provider-resolution field into the command payloads and run reports, then verify the same contract stays stable in the flow and sample-video paths.
