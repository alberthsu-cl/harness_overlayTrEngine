...
class ScoringAlignmentTests(unittest.TestCase):
                            ...
                            "execution": {
                                ...
                                "model_execution_contract": {
                                    ...
                                    "request_contract": {
                                        ...
                                        "inputs": {
                                            "transition_video_analysis": "dict[str, Any] | None",
                                        },
                                    },
                                    "result_contract": {
                                        "analysis_source": "str",
    ...
    def test_analyze_transition_command_records_requested_provider_metadata(self) -> None:
        ...
        self.assertEqual(stdout_payload["analysis_provider_requested"]["kind"], "model_backed")
        self.assertEqual(stdout_payload["analysis_provider_requested"]["mode"], "vision")
        self.assertEqual(stdout_payload["analysis_provider_selected"]["kind"], "deterministic_rules")
        self.assertEqual(stdout_payload["analysis_provider_selected"]["name"], "deterministic_rules_v1")
        self.assertEqual(stdout_payload["analysis_provider_delegation"]["path"], "deterministic")
        self.assertEqual(stdout_payload["analysis_provider_resolution"]["status"], "fallback_to_deterministic")
        self.assertEqual(stdout_payload["analysis_provider_resolution_requested"]["kind"], "model_backed")
        self.assertEqual(stdout_payload["analysis_provider_resolution_resolved"]["kind"], "deterministic_rules")
        self.assertEqual(stdout_payload["analysis_provider_resolution_configuration"]["loaded"], True)
        self.assertEqual(stdout_payload["analysis_provider_resolution_status"], "fallback_to_deterministic")
        ...
        self.assertEqual(stdout_payload["analysis_provider_configuration_default_provider"]["kind"], "deterministic_rules")
        self.assertEqual(stdout_payload["analysis_provider_configuration_model_backed_provider"]["kind"], "model_backed")
        self.assertEqual(stdout_payload["analysis_provider_configuration_default_provider_kind"], "deterministic_rules")
        self.assertEqual(stdout_payload["analysis_provider_configuration_default_provider_name"], "deterministic_rules_v1")
        self.assertEqual(stdout_payload["analysis_provider_configuration_default_provider_mode"], "deterministic")
    ...
    def test_model_executor_can_be_overridden_by_env_hook(self) -> None:
        ...
        class CustomExecutor:
            def execute_model_request(self, model_request):
                return {
                    ...
                    "executor_source": model_request["inputs"]["executor_source"],
                    "hint": {
                ...
                model_result = executor.execute_model_request(
                    {
                        ...
                        "inputs": {
                            ...
                            "executor_source": "env:test_transition_model_executor_override:build_executor",
        ...
        self.assertEqual(model_result["executor_source"], "env:test_transition_model_executor_override:build_executor")
        self.assertEqual(model_result["hint"]["analysis"]["style_reason"], "custom executor override used")

    def test_model_executor_env_hook_reports_source(self) -> None:
            ...
            model_result = executor.execute_model_request(
                {
                    ...
                    "inputs": {
                        ...
                        "prefer_generated": False,
                        "reference_transition": None,
                        "job_name": "source_report_executor_job",
                        "source_a": str(HARNESS_ROOT.parent / "harness/examples/inputs/source_a_real"),
                        "source_b": str(HARNESS_ROOT.parent / "harness/examples/inputs/source_b_real"),
                    },
                    "analyzer_inputs": {
    ...
    def test_model_backed_provider_uses_custom_executor_boundary(self) -> None:
        ...
        self.assertEqual(hint["analysis"]["model_execution"]["request"]["inputs"]["executor_source"], "default:DeterministicTransitionModelExecutor")
    ...
    def test_analyze_transition_video_records_requested_provider_metadata(self) -> None:
        ...
        self.assertEqual(hint["analysis_model_execution_contract"]["contract_type"], "transition_analysis_model_execution")
        self.assertEqual(hint["analysis_model_execution_contract"]["request_contract"]["inputs"]["transition_video_analysis"], "dict[str, Any] | None")
        self.assertEqual(hint["analysis_model_execution_contract"]["request_contract"]["inputs"]["transition_summary"], "dict[str, Any] | None")
        ...
        self.assertEqual(hint["analysis_model_execution_contract"]["result_contract"]["transition_video_analysis"], "dict[str, Any] | None")
    ...
    def _flow_command_persists_end_to_end_evaluation_summary(self) -> None:
        ...
        self.assertEqual(payload["data"]["analysis_provider_delegation"]["path"], "deterministic")
        self.assertEqual(payload["data"]["analysis_provider_resolution"]["resolved"]["kind"], "deterministic_rules")
        self.assertEqual(payload["data"]["analysis_provider_resolution_requested"]["kind"], "deterministic_rules")
        self.assertEqual(payload["data"]["analysis_provider_resolution_resolved"]["kind"], "deterministic_rules")
        ...
        self.assertEqual(payload["data"]["analysis_provider_configuration_default_provider_kind"], "deterministic_rules")
        self.assertEqual(payload["data"]["analysis_provider_configuration_default_provider_name"], "deterministic_rules_v1")
        self.assertEqual(payload["data"]["analysis_provider_configuration_default_provider_mode"], "deterministic")
    ...
    def test_sample_video_command_with_explicit_fx_id_copies_output_video(self) -> None:
        ...
        self.assertIsNone(stdout_payload["analysis_provider_requested"])
        self.assertIsNone(stdout_payload["analysis_provider_selected"])
        self.assertIsNone(stdout_payload["analysis_provider_delegation"])
        self.assertIsNone(stdout_payload["analysis_provider_resolution"])
        self.assertIsNone(stdout_payload["analysis_provider_resolution_requested"])
        self.assertIsNone(stdout_payload["analysis_provider_resolution_resolved"])
        self.assertIsNone(stdout_payload["analysis_provider_resolution_configuration"])
        ...
        self.assertIsNone(stdout_payload["analysis_provider_configuration_path"])
        self.assertIsNone(stdout_payload["analysis_provider_configuration_version"])
        ...
        self.assertIsNone(stdout_payload["analysis_provider_configuration_default_provider_kind"])
        self.assertIsNone(stdout_payload["analysis_provider_configuration_default_provider_name"])
        self.assertIsNone(stdout_payload["analysis_provider_configuration_default_provider_mode"])
